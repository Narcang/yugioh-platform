...
const it = {
    ...
    lobby: {
        ...
        skillLevel: 'Livello',
        skillAny: 'Qualsiasi',
        skillHint: 'Più alto, più i mazzi sono competitivi.',
        skill: {
            magic1: 'Bracket 1',
            magic2: 'Bracket 2',
            magic3: 'Bracket 3',
        ...
        createTitle: 'Crea nuova partita',
        createName: 'Nome lobby',
        createNamePh: 'Inserisci il nome della stanza…',
        createGame: 'Gioco',
        createLanguage: 'Lingua',
        createFormat: 'Formato',
        createPlayers: 'Giocatori',
        createMode: 'Modalità',
        createOnly1v1: '{game} {format} si gioca solo in 1 contro 1.',
        createSummary: '{n} giocatori, {mode}.',
        createLife: 'Vita iniziale: {lp} per giocatore.',
        mode1v1: '1 contro 1',
        modeTeams: 'Squadre 2v2',
        modeFfa: 'Tutti contro tutti',
        players2: '2 giocatori (1v1)',
        playersN: '{n} giocatori',
        publicMatch: 'Partita pubblica',
        publicHint: 'Chiunque può unirsi alla partita.',
        privateHint: 'Serve una password per entrare.',
        roomPassword: 'Password della stanza',
        roomPasswordPh: 'Scegli una password…',
        roomPasswordNeed: 'Almeno 4 caratteri.',
        roomDescription: 'Descrizione (facoltativa)',
        roomDescriptionPh: 'Aggiungi dettagli…',
        createSubmit: 'Crea lobby',
    },
    play: {
        ...
        tokens: 'Segnalini',
        tokensHint: 'Trascina un segnalino sulla carta o sul campo, col mouse o col dito.',
        tokensArmed: 'Tocca una carta o il campo per posarlo.',
        tokenInc: 'Aggiungi uno',
        tokenDec: 'Togli uno',
        tokenRemove: 'Rimuovi',
        tokenName: {
            p1p1: '+1/+1',
        ...
        diceCoin: 'Lancio della moneta',
        diceResult: 'Risultato',
        diceBack: 'Indietro',
        diceHeads: 'Testa',
        diceTails: 'Croce',
        diceRolled: '{name} ha lanciato',
        guide: 'Guida',
        guideTitle: 'Tasti del tavolo',
        guideLead: 'Cosa fa ciascun tasto della barra di gioco.',
        guideClose: 'Ho capito',
        guidePhase: 'Avanza la fase del turno. All’ultima fase passa il turno.',
        guidePass: 'Passa il turno all’avversario.',
        guideMic: 'Accendi o spegni il microfono.',
        guideCam: 'Accendi o spegni la camera.',
        guideFull: 'Primo piano su un giocatore.',
        guideGrid: 'Tutti i posti visibili, a griglia.',
        guideBox: 'Avversario grande, tu in riquadro.',
        guideCards: 'Cerca e mostra carte.',
        guideInvite: 'Copia il link della stanza.',
        guideSettings: 'Impostazioni della partita.',
        guideDice: 'Dadi e moneta. Il risultato lo vedono tutti al tavolo.',
        guideTokens: 'Segnalini da trascinare sulle carte o sul campo.',
        guidePhaseTitle: 'Fase',
        guidePassTitle: 'Passa',
        guideMicTitle: 'Microfono',
        guideCamTitle: 'Camera',
        guideFullTitle: 'Primo piano',
        guideGridTitle: 'Griglia',
        guideBoxTitle: 'Riquadro',
        guideCardsTitle: 'Carte',
        guideInviteTitle: 'Invita',
        guideSettingsTitle: 'Impostazioni',
        guideDiceTitle: 'Dadi',
    },
    how: {
...
const en: Messages = {
    ...
    lobby: {
        ...
        confirm: 'Confirm',
        cancel: 'Cancel',
        skillLevel: 'Power level',
        skillAny: 'Any',
        skillHint: 'Higher means more competitive decks.',
        skill: {
            magic1: 'Bracket 1',
            magic2: 'Bracket 2',
            magic3: 'Bracket 3',
        ...
        createTitle: 'Create a new match',
        createName: 'Lobby name',
        createNamePh: 'Enter the room name…',
        createGame: 'Game',
        createLanguage: 'Language',
        createFormat: 'Format',
        createPlayers: 'Players',
        createMode: 'Mode',
        createOnly1v1: '{game} {format} is 1v1 only.',
        createSummary: '{n} players, {mode}.',
        createLife: 'Starting life: {lp} per player.',
        mode1v1: '1 vs 1',
        modeTeams: '2v2 teams',
        modeFfa: 'Free for all',
        players2: '2 players (1v1)',
        playersN: '{n} players',
        publicMatch: 'Public match',
        publicHint: 'Anyone can join this match.',
        privateHint: 'A password is required to join.',
        roomPassword: 'Room password',
        roomPasswordPh: 'Choose a password…',
        roomPasswordNeed: 'At least 4 characters.',
        roomDescription: 'Description (optional)',
        roomDescriptionPh: 'Add details…',
        createSubmit: 'Create lobby',
    },
    play: {
        ...
        tokens: 'Counters',
        tokensHint: 'Drag a counter onto a card or the field, with mouse or finger.',
        tokensArmed: 'Tap a card or the field to place it.',
        tokenInc: 'Add one',
        tokenDec: 'Remove one',
        tokenRemove: 'Remove',
        tokenName: {
        ...
        diceHeads: 'Heads',
        diceTails: 'Tails',
        diceRolled: '{name} rolled',
        guide: 'Guide',
        guideTitle: 'Table buttons',
        guideLead: 'What each button on the play bar does.',
        guideClose: 'Got it',
        guidePhase: 'Advance the turn phase. On the last phase, pass the turn.',
        guidePass: 'Pass the turn to the opponent.',
        guideMic: 'Mute or unmute the microphone.',
        guideCam: 'Turn the camera on or off.',
        guideFull: 'Close-up on one player.',
        guideGrid: 'All seats visible, in a grid.',
        guideBox: 'Opponent large, you in a picture-in-picture.',
        guideCards: 'Search and show cards.',
        guideInvite: 'Copy the room link.',
        guideSettings: 'Match settings.',
        guideDice: 'Dice and coin. Everyone at the table sees the result.',
        guideTokens: 'Counters to drag onto cards or the field.',
        guidePhaseTitle: 'Phase',
        guidePassTitle: 'Pass',
        guideMicTitle: 'Microphone',
        guideCamTitle: 'Camera',
        guideFullTitle: 'Close-up',
        guideGridTitle: 'Grid',
        guideBoxTitle: 'Picture-in-picture',
        guideCardsTitle: 'Cards',
        guideInviteTitle: 'Invite',
...
const es: Messages = {
    ...
    lobby: {
        ...
        skillLevel: 'Nivel',
        skillAny: 'Cualquiera',
        skillHint: 'Cuanto más alto, más competitivos son los mazos.',
        skill: {
            magic1: 'Bracket 1',
            magic2: 'Bracket 2',
            magic3: 'Bracket 3',
        ...
        createTitle: 'Crear partida nueva',
        createName: 'Nombre de la sala',
        createNamePh: 'Escribe el nombre de la sala…',
        createGame: 'Juego',
        createLanguage: 'Idioma',
        createFormat: 'Formato',
        createPlayers: 'Jugadores',
        createMode: 'Modo',
        createOnly1v1: '{game} {format} se juega solo 1 contra 1.',
        createSummary: '{n} jugadores, {mode}.',
        createLife: 'Vida inicial: {lp} por jugador.',
        mode1v1: '1 contra 1',
        modeTeams: 'Equipos 2v2',
        modeFfa: 'Todos contra todos',
        players2: '2 jugadores (1v1)',
        playersN: '{n} jugadores',
        publicMatch: 'Partida pública',
        publicHint: 'Cualquiera puede unirse.',
        privateHint: 'Hace falta una contraseña para entrar.',
        roomPassword: 'Contraseña de la sala',
        roomPasswordPh: 'Elige una contraseña…',
        roomPasswordNeed: 'Al menos 4 caracteres.',
        roomDescription: 'Descripción (opcional)',
        roomDescriptionPh: 'Añade detalles…',
    ...
    play: {
        ...
        tokens: 'Marcadores',
        tokensHint: 'Arrastra un marcador a una carta o al campo, con el ratón o el dedo.',
        tokensArmed: 'Toca una carta o el campo para colocarlo.',
        tokenInc: 'Añadir uno',
        tokenDec: 'Quitar uno',
        tokenRemove: 'Quitar',
        tokenName: {
        ...
        diceCoin: 'Lanzar una moneda',
        diceResult: 'Resultado',
        diceBack: 'Atrás',
        diceHeads: 'Cara',
        diceTails: 'Cruz',
        diceRolled: '{name} ha lanzado',
        guide: 'Guía',
        guideTitle: 'Botones de la mesa',
        guideLead: 'Qué hace cada botón de la barra de juego.',
        guideClose: 'Entendido',
        guidePhase: 'Avanza la fase del turno. En la última fase, pasa el turno.',
        guidePass: 'Pasa el turno al rival.',
        guideMic: 'Activa o silencia el micrófono.',
        guideCam: 'Enciende o apaga la cámara.',
        guideFull: 'Primer plano de un jugador.',
        guideGrid: 'Todos los asientos visibles, en cuadrícula.',
        guideBox: 'Rival grande, tú en recuadro.',
        guideCards: 'Busca y muestra cartas.',
        guideInvite: 'Copia el enlace de la sala.',
        guideSettings: 'Ajustes de la partida.',
        guideDice: 'Dados y moneda. El resultado lo ven todos en la mesa.',
        guideTokens: 'Marcadores para arrastrar a las cartas o al campo.',
        guidePhaseTitle: 'Fase',
        guidePassTitle: 'Pasar',
        guideMicTitle: 'Micrófono',
        guideCamTitle: 'Cámara',
        guideFullTitle: 'Primer plano',
        guideGridTitle: 'Cuadrícula',
        guideBoxTitle: 'Recuadro',
        guideCardsTitle: 'Cartas',
        guideInviteTitle: 'Invitar',
        guideSettingsTitle: 'Ajustes',
        guideDiceTitle: 'Dados',
    },
    how: {
...
const fr: Messages = {
    ...
    lobby: {
        ...
        cancel: 'Annuler',
        skillLevel: 'Niveau',
        skillAny: 'Indifférent',
        skillHint: 'Plus c’est haut, plus les decks sont compétitifs.',
        skill: {
            magic1: 'Bracket 1',
            magic2: 'Bracket 2',
            magic3: 'Bracket 3',
            ...
            other1: 'Casual',
            other2: 'Locals',
            other3: 'Intermédiaire',
            other4: 'Compétitif',
            other5: 'Meta',
        },
        createTitle: 'Créer une partie',
        createName: 'Nom du salon',
        createNamePh: 'Entre le nom de la salle…',
        createGame: 'Jeu',
        createLanguage: 'Langue',
        createFormat: 'Format',
        createPlayers: 'Joueurs',
        createMode: 'Mode',
        createOnly1v1: '{game} {format} se joue uniquement en 1 contre 1.',
        createSummary: '{n} joueurs, {mode}.',
        createLife: 'Vie de départ : {lp} par joueur.',
        mode1v1: '1 contre 1',
        modeTeams: 'Équipes 2v2',
        modeFfa: 'Chacun pour soi',
        players2: '2 joueurs (1v1)',
        playersN: '{n} joueurs',
        publicMatch: 'Partie publique',
        publicHint: 'Tout le monde peut rejoindre.',
        privateHint: 'Un mot de passe est requis pour entrer.',
        roomPassword: 'Mot de passe de la salle',
        roomPasswordPh: 'Choisis un mot de passe…',
        roomPasswordNeed: 'Au moins 4 caractères.',
        roomDescription: 'Description (facultative)',
        roomDescriptionPh: 'Ajoute des détails…',
    ...
    play: {
        ...
        tokens: 'Marqueurs',
        tokensHint: 'Glisse un marqueur sur une carte ou le champ, à la souris ou au doigt.',
        tokensArmed: 'Touche une carte ou le champ pour le poser.',
        tokenInc: 'Ajouter un',
        tokenDec: 'Retirer un',
        tokenRemove: 'Retirer',
        tokenName: {
        ...
        diceCoin: 'Pile ou face',
        diceResult: 'Résultat',
        diceBack: 'Retour',
        diceHeads: 'Face',
        diceTails: 'Pile',
        diceRolled: '{name} a lancé',
        guide: 'Guide',
        guideTitle: 'Boutons de la table',
        guideLead: 'Ce que fait chaque bouton de la barre de jeu.',
        guideClose: 'Compris',
        guidePhase: 'Avance la phase du tour. À la dernière phase, passe le tour.',
        guidePass: 'Passe le tour à l’adversaire.',
        guideMic: 'Active ou coupe le micro.',
        guideCam: 'Allume ou éteint la caméra.',
        guideFull: 'Gros plan sur un joueur.',
        guideGrid: 'Tous les sièges visibles, en grille.',
        guideBox: 'Adversaire en grand, toi en encadré.',
        guideCards: 'Cherche et montre des cartes.',
        guideInvite: 'Copie le lien de la salle.',
        guideSettings: 'Réglages de la partie.',
        guideDice: 'Dés et pièce. Tout le monde à la table voit le résultat.',
        guideTokens: 'Marqueurs à glisser sur les cartes ou le champ.',
        guidePhaseTitle: 'Phase',
        guidePassTitle: 'Passer',
        guideMicTitle: 'Micro',
        guideCamTitle: 'Caméra',
        guideFullTitle: 'Gros plan',
        guideGridTitle: 'Grille',
        guideBoxTitle: 'Encadré',
        guideCardsTitle: 'Cartes',
        guideInviteTitle: 'Inviter',
        guideSettingsTitle: 'Réglages',
        guideDiceTitle: 'Dés',
    },
    how: {
...
const de: Messages = {
    ...
    lobby: {
        ...
        confirm: 'Bestätigen',
        cancel: 'Abbrechen',
        skillLevel: 'Stärkegrad',
        skillAny: 'Egal',
        skillHint: 'Je höher, desto kompetitiver die Decks.',
        skill: {
            magic1: 'Bracket 1',
            magic2: 'Bracket 2',
            magic3: 'Bracket 3',
        ...
        createTitle: 'Neues Spiel erstellen',
        createName: 'Lobby-Name',
        createNamePh: 'Namen des Raums eingeben…',
        createGame: 'Spiel',
        createLanguage: 'Sprache',
        createFormat: 'Format',
        createPlayers: 'Spieler',
        createMode: 'Modus',
        createOnly1v1: '{game} {format} wird nur 1 gegen 1 gespielt.',
        createSummary: '{n} Spieler, {mode}.',
        createLife: 'Startleben: {lp} pro Spieler.',
        mode1v1: '1 gegen 1',
        modeTeams: '2v2-Teams',
        modeFfa: 'Jeder gegen jeden',
        players2: '2 Spieler (1v1)',
        playersN: '{n} Spieler',
        publicMatch: 'Öffentliches Spiel',
        publicHint: 'Jeder kann beitreten.',
        privateHint: 'Zum Beitreten wird ein Passwort gebraucht.',
        roomPassword: 'Raum-Passwort',
        roomPasswordPh: 'Passwort wählen…',
        roomPasswordNeed: 'Mindestens 4 Zeichen.',
        roomDescription: 'Beschreibung (optional)',
        roomDescriptionPh: 'Details hinzufügen…',
        createSubmit: 'Lobby erstellen',
    },
    play: {
        ...
        continue: 'Ins Spiel',
        tokens: 'Marker',
        tokensHint: 'Zieh einen Marker auf eine Karte oder das Feld, mit Maus oder Finger.',
        tokensArmed: 'Tippe eine Karte oder das Feld, um ihn zu legen.',
        tokenInc: 'Eins hinzufügen',
        tokenDec: 'Eins entfernen',
        tokenRemove: 'Entfernen',
        tokenName: {
            p1p1: '+1/+1',
            m1m1: '−1/−1',
        ...
        diceHeads: 'Kopf',
        diceTails: 'Zahl',
        diceRolled: '{name} hat geworfen',
        guide: 'Anleitung',
        guideTitle: 'Tasten am Tisch',
        guideLead: 'Was jede Taste in der Spielleiste macht.',
        guideClose: 'Verstanden',
        guidePhase: 'Geht zur nächsten Phase. In der letzten Phase wird der Zug abgegeben.',
        guidePass: 'Gibt den Zug an den Gegner ab.',
        guideMic: 'Mikrofon ein- oder ausschalten.',
        guideCam: 'Kamera ein- oder ausschalten.',
        guideFull: 'Nahaufnahme eines Spielers.',
        guideGrid: 'Alle Plätze sichtbar, im Raster.',
        guideBox: 'Gegner groß, du im Bild-in-Bild.',
        guideCards: 'Karten suchen und zeigen.',
        guideInvite: 'Link zum Raum kopieren.',
        guideSettings: 'Spieleinstellungen.',
        guideDice: 'Würfel und Münze. Das Ergebnis sehen alle am Tisch.',
        guideTokens: 'Marker zum Ziehen auf Karten oder das Feld.',
        guidePhaseTitle: 'Phase',
        guidePassTitle: 'Passen',
        guideMicTitle: 'Mikrofon',
        guideCamTitle: 'Kamera',
        guideFullTitle: 'Nahaufnahme',
        guideGridTitle: 'Raster',
        guideBoxTitle: 'Bild-in-Bild',
        guideCardsTitle: 'Karten',
        guideInviteTitle: 'Einladen',
        guideSettingsTitle: 'Einstellungen',
        guideDiceTitle: 'Würfel',
    },
    how: {
...
const pt: Messages = {
    ...
    lobby: {
        ...
        skillLevel: 'Nível',
        skillAny: 'Qualquer',
        skillHint: 'Quanto mais alto, mais competitivos são os decks.',
        skill: {
            magic1: 'Bracket 1',
            magic2: 'Bracket 2',
            magic3: 'Bracket 3',
            ...
            other1: 'Casual',
            other2: 'Locals',
            other3: 'Intermediário',
            other4: 'Competitivo',
            other5: 'Meta',
        },
        createTitle: 'Criar partida nova',
        createName: 'Nome da sala',
        createNamePh: 'Digite o nome da sala…',
        createGame: 'Jogo',
        createLanguage: 'Idioma',
        createFormat: 'Formato',
        createPlayers: 'Jogadores',
        createMode: 'Modo',
        createOnly1v1: '{game} {format} é só 1 contra 1.',
        createSummary: '{n} jogadores, {mode}.',
        createLife: 'Vida inicial: {lp} por jogador.',
        mode1v1: '1 contra 1',
        modeTeams: 'Times 2v2',
        modeFfa: 'Todos contra todos',
        players2: '2 jogadores (1v1)',
        playersN: '{n} jogadores',
        publicMatch: 'Partida pública',
        publicHint: 'Qualquer um pode entrar.',
        privateHint: 'É preciso uma senha para entrar.',
        roomPassword: 'Senha da sala',
        roomPasswordPh: 'Escolha uma senha…',
        roomPasswordNeed: 'Pelo menos 4 caracteres.',
        roomDescription: 'Descrição (opcional)',
        roomDescriptionPh: 'Adicione detalhes…',
        createSubmit: 'Criar sala',
    },
    play: {
        ...
        tokens: 'Marcadores',
        tokensHint: 'Arraste um marcador para uma carta ou o campo, com o mouse ou o dedo.',
        tokensArmed: 'Toque numa carta ou no campo para colocá-lo.',
        tokenInc: 'Adicionar um',
        tokenDec: 'Tirar um',
        tokenRemove: 'Remover',
        tokenName: {
            p1p1: '+1/+1',
        ...
        diceCoin: 'Cara ou coroa',
        diceResult: 'Resultado',
        diceBack: 'Voltar',
        diceHeads: 'Cara',
        diceTails: 'Coroa',
        diceRolled: '{name} lançou',
        guide: 'Guia',
        guideTitle: 'Botões da mesa',
        guideLead: 'O que cada botão da barra de jogo faz.',
        guideClose: 'Entendi',
        guidePhase: 'Avança a fase do turno. Na última fase, passa o turno.',
        guidePass: 'Passa o turno para o oponente.',
        guideMic: 'Liga ou desliga o microfone.',
        guideCam: 'Liga ou desliga a câmera.',
        guideFull: 'Close de um jogador.',
        guideGrid: 'Todos os assentos visíveis, em grade.',
        guideBox: 'Oponente grande, você em recorte.',
        guideCards: 'Busca e mostra cartas.',
        guideInvite: 'Copia o link da sala.',
        guideSettings: 'Configurações da partida.',
        guideDice: 'Dados e moeda. O resultado aparece para todos na mesa.',
        guideTokens: 'Marcadores para arrastar às cartas ou ao campo.',
        guidePhaseTitle: 'Fase',
        guidePassTitle: 'Passar',
        guideMicTitle: 'Microfone',
        guideCamTitle: 'Câmera',
        guideFullTitle: 'Close',
        guideGridTitle: 'Grade',
        guideBoxTitle: 'Recorte',
        guideCardsTitle: 'Cartas',
        guideInviteTitle: 'Convidar',
